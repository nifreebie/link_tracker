...
@Component
public class RemoveTagsFromLinkCommandBuilder extends CommandBuilder implements BotMessages {

    private final TelegramBot telegramBot;

    protected RemoveTagsFromLinkCommandBuilder(StateRepository stateRepository, TelegramBot telegramBot) {
    ...
    public Command build(Update update) {
        ...
        stateRepository.setState(update.message().chat().id(), UserState.AWAITING_REMOVE_TAGS_URL);
