...
@Component
public class TrackCommandBuilder extends CommandBuilder implements BotMessages {

    private final TelegramBot telegramBot;

    protected TrackCommandBuilder(StateRepository stateRepository, TelegramBot telegramBot) {
    ...
    public Command build(Update update) {
        ...
        stateRepository.setState(update.message().chat().id(), UserState.AWAITING_TRACK_URL);
